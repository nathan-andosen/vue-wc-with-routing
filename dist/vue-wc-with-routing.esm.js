...
function install (Vue$$1) {
  if (install.installed && _Vue === Vue$$1) { return }
  ...
  Vue$$1.mixin({
    beforeCreate: function beforeCreate () {
      if (isDef(this.$options.router)) {
        ...
        Vue$$1.util.defineReactive(this, '_route', this._router.history.current);
      } else {
  ...
  Object.defineProperty(Vue$$1.prototype, '$router', {
    get: function get () { return this._routerRoot._router }
  });

  Object.defineProperty(Vue$$1.prototype, '$route', {
    get: function get () { return this._routerRoot._route }
  });

  Vue$$1.component('router-view', View);
  Vue$$1.component('router-link', Link);
  ...
  return _c(
    ...
    [
      _c(
        ...
        { attrs: { id: "nav" } },
        [
          _c("router-link", { attrs: { to: "/wc/home" } }, [_vm._v("Home")]),
          _vm._v(" |\n    "),
          _c("router-link", { attrs: { to: "/wc/about" } }, [_vm._v("About")])
        ],
        1
      ),
      _vm._v(" "),
...
var VueWcWithRoutingComponent$1 = /** @class */ (function (_super) {
    __extends(VueWcWithRoutingComponent, _super);
    function VueWcWithRoutingComponent() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     ...
     * @param {any} data
     */
    VueWcWithRoutingComponent.prototype.passData = function (data) {
        // this method can be called from the custom element that gets created
    };
    __decorate([
        Prop({ default: 'Welcome!' })
    ], VueWcWithRoutingComponent.prototype, "welcomeMessage", void 0);
    VueWcWithRoutingComponent = __decorate([
        Component({
            name: COMPONENT_NAME
        })
    ], VueWcWithRoutingComponent);
    return VueWcWithRoutingComponent;
}(Vue));
